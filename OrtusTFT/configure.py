...
def main():
    begin = ask_question("Hi, welcome to the OrtusTFT setup. Would you like to [r]eset everything, reset the [d]isplay calibration, reset the [w]eather login, or change your [n]ame? ", valid_answers="rdwn")
